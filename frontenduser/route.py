...
def subscription_details(suid: str, sql: Session = Depends(get_db)):
    """
...
def all_timezones(sql: Session = Depends(get_db)):
    """
...
def stripe_checkout():
    ...
    """
    return FileResponse(
        os.path.join(TEMPLATES, "stripe_checkout.html"), media_type="text/html"
    )
...
def razorpay_checkout():
    ...
    """
    return FileResponse(
        os.path.join(TEMPLATES, "razorpay_checkout.html"), media_type="text/html"
    )
...
def paypal_checkout():
    ...
    """
    return FileResponse(
        os.path.join(TEMPLATES, "paypal_checkout.html"), media_type="text/html"
    )
